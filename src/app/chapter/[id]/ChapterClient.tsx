...
export default function ChapterClient({ parentChapter }: ChapterClientProps) {
              ...
              return (
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-xs text-gray-500">
                    Part {index + 1} of {parentChapter.children?.length || 0}
                  </div>
                </div>
              </Link>
              );
        ...
        <section className="p-6 bg-white rounded-lg shadow-md">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            <div className="text-center">
              <div className="text-2xl font-bold text-purple-600">{parentChapter.children?.length || 0}</div>
              <div className="text-sm text-gray-600">Total Sections</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-blue-600">
                {parentChapter.children?.reduce((total, child) => total + child.questions.length, 0) || 0}
              </div>
